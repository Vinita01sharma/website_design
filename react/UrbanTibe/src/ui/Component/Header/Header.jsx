    ...
    return (
        <div>
            <div className="text-center py-2.5 text-sm m-0 text-white bg-red-600">
                <div className="container">
                    <div className="tt-row padding-top:10px;min-height:0px;">
                        <div className="tt-description font-size:14px; line-height:21px; font-weight:400;"> Get Rs 100 Off on Prepaid Orders | Free Shipping All&nbsp;Over&nbsp;India
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="bg-[#f7f8fa] border-b border-gray-200 text-[#777777] flex px-2 py-1 justify-around">
                ...
                <input name="type" className='bg-gray-400 text-white placeholder:text-white'  placeholder='Search' />
