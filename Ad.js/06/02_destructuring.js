...
//   let data = { brandName: "xyz", model: "bdjas", price: 234 };
  ...
  let data = {brandName: "kia", model: "k5657jk", price:23234234}

// let {brandName, model, price} = data


function car({brandName, model, price}) {
    console.log(`car's brand name is ${brandName} model of the car is ${model} and price of the car is ${price}`);
